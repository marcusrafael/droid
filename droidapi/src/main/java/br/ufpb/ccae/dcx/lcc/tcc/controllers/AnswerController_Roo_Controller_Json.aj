...
privileged aspect AnswerController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> AnswerController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
        ...
        try {
            ...
            headers.add("Location",uriBuilder.path(a.value()[0]+"/"+answer.getId().toString()).build().toUriString());
